...
event bro_init()
{
	...
	local filter: Log::Filter = [$name="postgres_b", $path="mail_links", $writer=Log::WRITER_POSTGRESQL, $config=table(["conninfo"]="host=pg.lbl.gov dbname=cluster4.lbl.gov user=bro password=brodatabase")];
