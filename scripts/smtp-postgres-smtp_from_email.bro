...
event bro_init()
{
	...
	local filter: Log::Filter = [$name="postgres_from_email_rec", $path="smtp_from_email", $writer=Log::WRITER_POSTGRESQL, $config=table(["conninfo"]="host=localhost dbname=bro user=bro password=")];
