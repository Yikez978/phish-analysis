...
event bro_init()
{
	...
	local filter: Log::Filter = [$name="postgres_from_name_rec", $path="smtp_from_name", $writer=Log::WRITER_POSTGRESQL, $config=table(["conninfo"]="host=pg.lbl.gov dbname=cluster4.lbl.gov user=bro password=brodatabase")];
